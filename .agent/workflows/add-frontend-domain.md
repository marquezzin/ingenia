---
description: como criar um novo domínio frontend espelhando um app Django
---

# Workflow: Criar Novo Domínio Frontend

Este workflow descreve o passo a passo para adicionar um novo domínio ao frontend, espelhando um app Django existente.

Antes de começar, leia: `.agent/rules/003-frontend.md`
...
12. **Crie o `.context.md`** do domain com: propósito, páginas, API contract, hooks, types, dependências e backend correspondente. Veja os `.context.md` existentes em outros domains como referência.
